...
public class CommunicationTransactionMapper {
    ...
    public CommunicationTransactionDto toDto(final CommunicationTransaction communicationTransaction) {
    ...
    public CommunicationTransaction toEntity(final CommunicationTransactionDto communicationTransactionDto) {
